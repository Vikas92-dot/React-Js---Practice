...
class App extends Component {
  ...
  handleGenderChange = (event) => {
    this.setState({ defaultGender: event.target.value });
  };
      ...
      <>
        ...
        <div className="container mt-3">
          ...
          <div className="row mt-2">
            ...
            <div className="col-md-6">
              <button onClick={() => this.setState({ defaultBranch: "CS" })} className="btn btn-primary" style={this.state.buttonDecoration}>
                CS ({this.state.studentList.filter(student => student.branch === "CS").length})
              </button>
              <button onClick={() => this.setState({ defaultBranch: "IT" })} className="btn btn-warning ml-2" style={this.state.buttonDecoration}>
                IT ({this.state.studentList.filter(student => student.branch === "IT").length})
              </button>
              <button onClick={() => this.setState({ defaultBranch: "CV" })} className="btn btn-dark ml-2" style={this.state.buttonDecoration}>
                CV ({this.state.studentList.filter(student => student.branch === "CV").length})
              </button>
              <button onClick={() => this.setState({ defaultBranch: "Mech" })} className="btn btn-info ml-2" style={this.state.buttonDecoration}>
                Mech ({this.state.studentList.filter(student => student.branch === "Mech").length})
              </button>
              <button onClick={() => this.setState({ defaultBranch: "All" })} className="btn btn-secondary ml-2" style={this.state.buttonDecoration}>
            ...
            <div className="col-md-6 mt-2">
              ...
              <label className="mr-3">
                <input
                  ...
                  name="genderFilter"
                  value="Male"
                  checked={this.state.defaultGender === "Male"}
              ...
              <label className="mr-3">
                <input
                  ...
                  name="genderFilter"
                  value="Female"
                  checked={this.state.defaultGender === "Female"}
                  onChange={this.handleGenderChange}
                /> Female
              </label>
              ...
              <label>
                <input
                  ...
                  name="genderFilter"
                  value="All"
                  checked={this.state.defaultGender === "All"}
                  onChange={this.handleGenderChange}
                /> All
              </label>
            </div>
